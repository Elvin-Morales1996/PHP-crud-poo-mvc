...
//creamos constante para identificar nuestra aplicacion
//APP_URL: Evita escribir manualmente la URL en cada enlace o script
    ...
    //date_default_timezone_set(): poner tu zona horaria donde vives es para utilizarlo en el CRUD 
